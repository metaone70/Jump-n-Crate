...
// Check floor collision for main character
CHECK_FLOOR_COLLISION:	{
			lda SPBACKGR_COLL_REG
			and #%00000001
			cmp #$01
			beq !+			
...
PrintData2Screen: {
			...
			PrintByteScreen(SPBACKGR_COLL_REG,20,0,2)
			PrintByteScreen(Player_On_Floor,24,0,2)
			rts 
}
...
Floor:				.byte $a0,$a0,$a0,$a0,$a0,$a0,$a0,$a0,$a0,$a0,$a0,$a0,$a0,$a0,$a0,$20,$20,$20,$20,$20
