...
!Skip:		sec 
			...
			cmp Floor_Value			// is it floor? If yes, then continue walking 
			beq !EdgeCheck+	  	    // and check screen edges
...
!Skip:		clc 					// move player left in accordance with walkspeed
			lda Player_x
			...
			jsr GetBelowChar		// otherwise, check if the character in on floor
			lda BelowCharVal		//look at below character
			cmp Floor_Value			// is it floor?
			beq !EdgeCheck+	 	    // if no, then check screen edges
...
!SkipEdgeCheck:
			...
			and #STATE_FALL
			beq !+
			lda PlayerJumpRSprite			// load the falling sprite 
			sta sprite1_data_pointer		// (standing and facing left)
			jmp !++							// and finish moving
...
JumpAndFall: {
	...
	!Skip:	// this part is fall back
			...
			lda BelowCharVal		//look at below character
			cmp Floor_Value			// is it floor?
			beq !FinJ+				// if yes, then finalize jump
...
!:			jsr delay
	...
	!FinJ:	lda Player_State
			and #[255 - STATE_FALL]
			sta Player_State
			lda Player_State
			cmp #$14
			bne !yl+
			ldy PlayerStandLSprite
			sty sprite1_data_pointer
	!yl:	cmp #$28
			bne !yr+
			ldy PlayerStandRSprite
			sty sprite1_data_pointer
...
PrintData2Screen: {
			...
			jsr GetBelowChar
			PrintByteScreen(BelowCharVal,15,3,0)	
...
Floor0:				.byte $a0,$a0,$a0,$a0,$a0,$20,$20,$20,$20,$20,$20,$a0,$a0,$a0,$a0,$20,$20,$20,$20,$20
					.byte $20,$a0,$a0,$a0,$a0,$a0,$a0,$20,$20,$20,$20,$20,$20,$a0,$a0,$a0,$a0,$a0,$a0,$a0
