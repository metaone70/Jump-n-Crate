...
up:		lda Player_State	// if player is already jumping
		and #[STATE_JUMP]	// then don't jump again
		bne !+
...
!PlayerDone:	
		...
		ora #[STATE_WALK_RIGHT + STATE_FACE_LEFT]
		sta Player_State
