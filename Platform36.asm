...
// Default-segment:
  ...
  // $0810-$12fb Program Listing
  // $1800-$1a80 Variables and tables
...
!Sc:	lda $47b3,x  								// and store it to a table
			...
			jsr GameOverSong
			PrintScreen(GameOverText1,$4400,17,14,1,9)
			PrintScreen(GameOverText2,$4400,10,15,1,22)
			WaitJoy2Fire()
			ClearScreen($4400,0)
...
!Cl:	lda $463d,y 		  				// get the character value from screen position
			tax
...
!:		lda $47a8,x 
			...
			jsr GameOverSong
			PrintScreen(GameOverText3,$4400,17,13,1,10) 
			PrintScreen(GameOverText2,$4400,10,14,1,22)
			WaitJoy2Fire()
			ClearScreen($4400,0)
...
Initialize: {
		  ...
		  sta Time_Status 					// time max = $3c (60)
...
GameOverText2:	.text "press fire to continue"
GameOverText3:	.text "time is up" 
...
.import binary "Final_screen_2.bin"
